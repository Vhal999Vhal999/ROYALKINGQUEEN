...
OWNER_USERNAME = getenv("OWNER_USERNAME","APNA_SYSTEM_BABY_lll")
BOT_USERNAME = getenv("BOT_USERNAME" , "system_music_prorobot")
BOT_NAME = getenv("BOT_NAME" , "MAHI")
ASSUSERNAME = getenv("ASSUSERNAME" , "BADNAM")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1002348470544))
OWNER_ID = int(getenv("OWNER_ID", 7636649988))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Badnam019/PURVI-MUSIC",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-YukkiMusic-08-30")
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+LzNBuSPw0ZxlZTJl")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+LzNBuSPw0ZxlZTJl")
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/q40mcz.jpg")
